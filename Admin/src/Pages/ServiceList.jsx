                            ...
                            <form onSubmit={serviceUpdateFun} className="grid grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" value={updateServiceOldPrice} onChange={(e) => setUpdateServiceOldPrice(e.target.value)} className="w-full border rounded-lg p-2" />
                                    </div>

                                    <div>
                                        <label className="block font-medium">New Price</label>
                                        <input type="text" value={updateServiceNewPrice} onChange={(e) => setUpdateServiceNewPrice(e.target.value)} className="w-full border rounded-lg p-2" required />
                                    </div>

                                    <div>
                                        <label className="block font-medium">Discount</label>
                                        <input type="text" value={updateServiceDiscount} onChange={(e) => setUpdateServiceDiscount(e.target.value)} className="w-full border rounded-lg p-2" />
                                    </div>
                                </div>
