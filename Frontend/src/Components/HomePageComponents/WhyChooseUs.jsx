...
const WhyChooseUs = () => {
  ...
  return (
    <section className="bg-gray-50 relative py-10 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      {/* Background Shapes */}
      ...
      <div className="relative container mx-auto px-6 text-center">
        ...
        <p className="text-lg text-gray-600 mb-12">
          We are dedicated to empowering students with real-world skills and
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-left">
          {points.map((point, index) => (
            <div
              key={index}
              className="flex items-start space-x-4 transform hover:scale-105 transition duration-300"
            >
              <div>{point.icon}</div>
              <div>
