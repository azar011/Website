    ...
    <section className="py-10 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
          Upgrade your career with our most in-demand courses, designed with
          industry experts to give you real-world skills.
        </p>
          ...
          {courseData.slice(0, 4).map((value, index) => (
            ...
            >
              <img
                ...
                src={
                  value.courseImage ? `${url}/uploads/${value.courseImage}` : ""
                }
