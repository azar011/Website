  ...
  return (
    <section className="py-10 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-12 max-w-3xl mx-auto">Upgrade your career with our most in-demand courses, designed with industry experts to give you real-world skills.</p>
          ...
          {courseData.slice(0, 4).map((value, index) => (
            <div
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">{value.courseDescription}</p>
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-medium transition" onClick={() => navigate(`/course/${value._id}`)}>
                  Read More
                </button>
              </div>
            </div>
