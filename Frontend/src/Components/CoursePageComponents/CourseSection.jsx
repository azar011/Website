    ...
    <div className="min-h-screen max-w-7xl mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {courseData.map((value, index) => (
          <div
            key={index}
            className="my-3 max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:scale-105 transition-transform duration-300 hover:shadow-[0_0_20px_silver]">
            ...
            <div className="p-5">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{value.courseShortDescription}</p>
              <a
