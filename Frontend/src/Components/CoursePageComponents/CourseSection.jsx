...
=======
    <div className=" max-w-7xl mx-auto rounded-xl mt-5 mx-5 ">
      <div className="min-h-screen max-w-7xl mx-auto p-8">
        <h2 className="text-3xl font-bold text-center mb-8">Our Courses</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {coursesData.map((course) => (
            <div
              key={course.id}
              className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:scale-105 transition-transform duration-300 hover:shadow-[0_0_20px_rgba(37,99,235,0.5)]">
              <a href="#">
                <img className="rounded-t-lg w-full h-48 object-cover" src={course.courseImg} alt={course.courseName} />
>>>>>>> 2586674753df5b63896b8835767aa732f2c62cb4
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{course.courseDescription}</p>
                <a
                  href={`/course/${course.id}`}
                  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Read More
