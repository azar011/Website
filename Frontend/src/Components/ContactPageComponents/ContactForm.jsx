            ...
            <div className="bg-white p-8 md:w-1/2">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <button
                  ...
                  className={`px-4 py-2 border rounded-lg text-sm cursor-pointer ${
                    selectedInterest === "UI/UX design" ? "bg-blue-600 text-white border-blue-600" : "border-gray-300 text-gray-700 hover:border-blue-700 hover:text-blue-700"
                  }`}>
                  Data Science
                </button>
                <button
                  ...
                  className={`px-4 py-2 border rounded-lg text-sm cursor-pointer ${
                    selectedInterest === "Web design" ? "bg-blue-600 text-white border-blue-600" : "border-gray-300 text-gray-700 hover:border-blue-700 hover:text-blue-700"
                  }`}>
                  Web Design
                </button>
                <button
                  ...
                  className={`px-4 py-2 border rounded-lg text-sm cursor-pointer ${
                    selectedInterest === "Graphic design" ? "bg-blue-600 text-white border-blue-600" : "border-gray-300 text-gray-700 hover:border-blue-700 hover:text-blue-700"
                  }`}>
                  Web Development
                </button>
                <button
                  ...
                  className={`px-4 py-2 border rounded-lg text-sm cursor-pointer ${
                    selectedInterest === "Design system" ? "bg-blue-600 text-white border-blue-600" : "border-gray-300 text-gray-700 hover:border-blue-700 hover:text-blue-700"
                  }`}>
                  Full Stack
                </button>
                <button
                  ...
                  className={`px-4 py-2 border rounded-lg text-sm cursor-pointer ${
                    selectedInterest === "Other" ? "bg-blue-600 text-white border-blue-600" : "border-gray-300 text-gray-700 hover:border-blue-700 hover:text-blue-700"
                  }`}>
                  Other
                </button>
              </div>
              ...
              <form className="space-y-5">
                <div>
                  ...
                  <input type="text" className="w-full border-b border-gray-300 focus:outline-none py-2" placeholder="Your Name" />
                </div>

                <div>
                  <input type="email" className="w-full border-b border-gray-300 focus:outline-none py-2" placeholder="Your Phone Number" />
                </div>

                <div>
                  <textarea rows="3" className="w-full border-b border-gray-300 focus:outline-none py-2" placeholder="Your Message"></textarea>
                </div>
